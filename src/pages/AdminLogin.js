...
const AdminLogin = () => {
    ...
    return (
        <form  noValidate autoComplete="off" style={{marginTop: '10vh', minHeight: '50vh'}}>
            ...
            <br />
            <Button type='submit' variant="contained" onClick={handleSubmit} style={{ backgroundColor: 'goldenrod', margin: '2rem', width: '25%', height: '3rem'}} >Submit</Button>
        </form>
    )
}
